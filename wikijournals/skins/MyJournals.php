...
require_once('include/SkinTemplate.php');
 ...
 * @ingroup Skins
 */
class SkinMyJournals extends SkinTemplate {
	/** Using myjournals. */
	var $skinname = 'myjournals', $stylename = 'myjournals',
		$template = 'MyJournalsTemplate', $useHeadElement = true;

	function setupSkinUserCss( OutputPage $out ) {
		global $wgHandheldStyle;
		parent::setupSkinUserCss( $out );

		$out->addModuleStyles( 'skins.myjournals' );
		...
		$out->addStyle( 'myjournals/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
		$out->addStyle( 'myjournals/IE55Fixes.css', 'screen', 'IE 5.5000' );
		$out->addStyle( 'myjournals/IE60Fixes.css', 'screen', 'IE 6' );
		$out->addStyle( 'myjournals/IE70Fixes.css', 'screen', 'IE 7' );
 ...
 * @ingroup Skins
 */
class MyJournalsTemplate extends BaseTemplate {
	...
	/**
	 * Template filter callback for MyJournals skin.
...
<?php
	 ...
	 * Shared between MyJournals and Modern
	 */
	function cactions() {
?>
...
<?php
		...
		wfRunHooks( 'MyJournalsTemplateToolboxEnd', array( &$this ) );
