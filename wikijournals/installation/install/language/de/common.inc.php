...
$arrLang['alert_directory_not_writable'] = "Das Verzeichnis <b>_FILE_DIRECTORY_</b> ist nicht beschreibbar! <br /> Sie müssen 'write' Berechtigungen (Zugriffsrechte 0755 oder 777, abhängig von Ihrer System-Einstellungen), für dieses Verzeichnis setzen, bevor Sie die Installation starten können!";
...
$arrLang['alert_unable_to_install'] = "Diese Anwendung kann nicht installiert werden, da eine Anwendung mit der gleichen Identität bereits installiert ist. <br>Sie können nur <b>Update</b> oder <b>Deinstallieren</b> ausführen. Vergewissern Sie sich vorher, dass Sie eine Sicherungskopie Ihrer Datenbank angelegt haben.";
...
$arrLang['alert_remove_files'] = "Aus Gründen der Sicherheit, entfernen Sie bitte <b>start.php</b> Datei-und den <b>install/</b> Ordner auf Ihrem Server!";
...
$arrLang['error_can_not_open_config_file'] = "Die Datenbank wurde erfolgreich erstellt! Konfigurationsdatei _config FILE_PATH kann nicht geöffnet werden um die Informationen zu speichern.";
$arrLang['error_can_not_read_file'] = "Datei SQL_DUMP_FILE_ kann nicht gelesen werden! Bitte überprüfen Sie, ob die Datei existiert.";
$arrLang['error_check_db_exists'] = "Datenbank-Verbindungs Fehler! Bitte überprüfen Sie, ob Ihre Datenbank vorhanden ist der Benutzer <b>_DATABASE_USERNAME_</b> Zugriff hat._ERROR_<br />";
$arrLang['error_check_db_connection'] = "Datenbank-Verbindungs Fehler! Bitte überprüfen Sie Ihre Verbindungsparameter._ERROR_<br />";
$arrLang['error_pdo_support'] = "Dieses Skript erfordert installierte PDO-Erweiterung.";
$arrLang['error_sql_executing'] = "SQL Ausführungsfehler! Bitte Schalten Sie den Debug-Modus ein und überprüfen Sie die Syntax der SQL-Dump-Datei.";
$arrLang['error_server_requirements'] = "Diese Installation erfodert, dass _SETTINGS_NAME_ aktiviert/installiert ist.";
$arrLang['error_vd_support'] = "Für dieses Skript muss die Virtual Directory Unterstützung eingeschaltet sein.";

$arrLang['admin_access_data'] = "Admin-Zugangsdaten";
$arrLang['admin_access_data_descr'] = "(Sie benötigen die, um den geschützten Admin-Bereich einzugeben)";
$arrLang['admin_email'] = "Admin Email";
$arrLang['admin_email_info'] = "Admin Email, die in SQL-Dump mit E-Mail-Platzhalter (falls definiert) ersetzt wird.";
...
$arrLang['admin_password_info'] = "Wir empfehlen ein Passwort zu verwenden, dass nicht im Wörterbuch gefunden werden kann. Das Passwort sollte aus Groß- und Kleinbuchstaben bestehen und mindestens ein Sonderzeichen enthalten (1-9,!, *, _, Etc.).";
...
$arrLang['database_host_info'] = "Hostname oder IP-Adresse des Datenbankservers. Der Datenbankserver kann in Form des Hostnamens (und / oder Port-Adresse), wie z.B. db1.myserver.com oder localhost:5432 oder in Form der IP-Adresse (z.B.192.168.0.1) angegeben werden"
...
$arrLang['database_name_info'] = "Name der Datenbank, in der die Daten gespeichert werden sollen. Ein Beispiel für einen Datenbank-Namen wäre 'testdb'.";
$arrLang['database_username'] = "Datenbank-Benutzername";
$arrLang['database_username_info'] = "Datenbank-Benutzername. Der Benutzername der verwendet werden soll, um sich mit der Datenbank zu verbinden. Ein Beispiel für einen Benutzernamen wäre 'test_123'.";
$arrLang['database_password'] = "Datenbank-Passwort";
$arrLang['database_password_info'] = "Datenbank-Passwort. Das Passwort wird zusammen mit dem Benutzernamen verwendet.";
$arrLang['database_prefix'] = "Datenbank-Präfix (optional)";
$arrLang['database_prefix_info'] = "Datenbank-Präfix. Wird verwendet, um den eindeutigen Präfix für Datenbanktabellen zu setzen und zu verhindern, dass eine ungewollte Vermischung mit anderen Daten stattfindet. Ein Beispiel für Datenbank-Präfix 'abc_'.";
...
$arrLang['folder_paths'] = "Ordnerpfade";
...
$arrLang['remove_configuration_button'] = "Entfernen Sie die Konfiguration und starten Sie neu";
...
$arrLang['start_all_over_text'] = "Wenn Sie diese Installation aus irgendeinem Grund entfernen möchten, können Sie den Installer zu zwingen, die aktuelle Konfiguration zu entfernen und wieder von vorn beginnen. <br><b>WARNUNG</b>: Sie müssen die Datenbank-Installation manuell rückgängig machen, um alle Änderungen, die gemacht wurden zu entfernen.";
...
$arrLang['test_connection'] = "Testen der Verbindung";
...
$arrLang['virtual_directory_support'] = "Unterstützung von virtuellen Verzeichnissen";
$arrLang['we_are_ready_to_installation'] = "Wir sind jetzt bereit, die Installation fortzusetzen";
$arrLang['we_are_ready_to_installation_text'] = "Bei diesem Schritt versucht der Setup-Assistent, alle benötigten Datenbank-Tabellen zu erstellen und sie mit Daten zu füllen. Wenn etwas schief geht, gehen Sie zurück, zu den Datenbank-Einstellungen und stellen Sie sicher, dass alle Informationen, die Sie eingegeben haben korrekt sind.";
